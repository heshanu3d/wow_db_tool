...
cond = {
    # '亡者复生': "s.spellname4='亡者复生'",
    # '邪恶灵气': "s.spellname4='邪恶灵气'",
    # '鲜血灵气': "s.spellname4='鲜血灵气'",
    # '死亡之握': "s.spellname4='死亡之握'",
    # '冰霜之路': "s.spellname4='冰霜之路'",
    # '复活盟友': "s.spellname4='复活盟友'",
    # '活力分流': "s.spellname4='活力分流'",

    # '传染': "s.spellname4='传染' and spellfamilyname=15 and s.spellrank4=''",
    # '湮灭': "s.spellname4='湮灭'",
    # '凋零缠绕': "s.spellname4='凋零缠绕'     and s.spellrank4 like '等级%' and spellfamilyname=15",
    # '暗影打击': "s.spellname4='暗影打击'     and s.spellrank4 like '等级%' and spellfamilyname=15",
    # '灵界打击': "s.spellname4='灵界打击'     and s.spellrank4 like '等级%' and spellfamilyname=15",
    # '鲜血打击': "s.spellname4='鲜血打击'     and s.spellrank4 like '等级%'",
    # '冰霜打击': "s.spellname4='冰霜打击'     and s.spellrank4 like '等级%'",
